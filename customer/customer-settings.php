<?php
session_start();
require '../config/config.php'; // Replace with your actual OCI connection file path
...
$query = "SELECT name, email, profile_image FROM customers WHERE customer_id = :id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $update = "UPDATE customers SET name = :name, email = :email, profile_image = :image WHERE customer_id = :id";
